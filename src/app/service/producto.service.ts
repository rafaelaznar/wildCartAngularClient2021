...
import { IPageProduct, IProducto, IProducto2Send } from '../model/producto-interfaces';
...
export class ProductoService {
  ...
  getPage(rpp: number, page: number, filter: string, order: string, direction: string, tipoproducto: number): Observable<IPageProduct> {  
    ...
    return this.http.get<IPageProduct>(this.sURL + "?page=" + page + "&size=" + rpp + strOrderUrl, httpOptions);
  }
}