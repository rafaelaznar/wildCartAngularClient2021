...
const routes: Routes = [
  ...
  { path: 'factura/plist', component: PlistFacturaRoutedComponent, resolve: { message: SessionResolver } },
  { path: 'factura/plist/usuario/:id', component: PlistFacturaRoutedComponent, resolve: { message: SessionResolver } },  
