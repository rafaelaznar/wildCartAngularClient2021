...
const routes: Routes = [
  ...
  {
    path: 'tipousuario/plist',
    component: PlistTipousuarioComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'tipousuario/view/:id',
    component: ViewTipousuarioComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'tipousuario/edit/:id',
    component: EditTipousuarioComponent,
    resolve: { message: SessionResolver },
  },

  {
    path: 'usuario/plist',
    component: PlistUsuarioComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'usuario/plist/:id_tipousuario',
    component: PlistUsuarioComponent,
    resolve: { message: SessionResolver },
  },
  {
  ...
  },
  {
    ...
    component: RemoveUsuarioComponent,
    resolve: { message: SessionResolver },
  },

  {
    path: 'tipoproducto/plist',
    component: PlistTipoproductoComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'tipoproducto/new',
    component: NewTipoproductoComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'tipoproducto/view/:id',
    component: ViewTipoproductoComponent,
    resolve: { message: SessionResolver },
  },
  {
  ...
  {
    path: 'tipoproducto/remove/:id',
    component: RemoveTipoproductoComponent,
    resolve: { message: SessionResolver },
  },

  {
    path: 'producto/plist',
    component: PlistProductoComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'producto/plist/tipoproducto/:id_tipoproducto',
    component: PlistProductoComponent,
    resolve: { message: SessionResolver },
  },
  {
  ...
  },
  {
    ...
    component: RemoveProductoComponent,
    resolve: { message: SessionResolver },
  },

  {
    path: 'compra/plist',
    component: PlistCompraComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'compra/new',
  ...
  {
    path: 'compra/remove/:id',
    component: RemoveCompraComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'compra/plist/factura/:id_factura',
    component: PlistCompraComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'compra/plist/producto/:id_producto',
    component: PlistCompraComponent,
    resolve: { message: SessionResolver },
  },
  ...
  {
    path: 'factura/plist',
    component: PlistFacturaComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'factura/new',
  ...
  {
    path: 'factura/remove/:id',
    component: RemoveFacturaComponent,
    resolve: { message: SessionResolver },
  },

  {
    path: 'carrito/plist',
    component: PlistCarritoComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'carrito/plist/producto/:idproducto',
    component: PlistCarritoComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'carrito/plist/usuario/:idusuario',
    component: PlistCarritoComponent,
    resolve: { message: SessionResolver },
  },
  {
  ...
  {
    path: 'carrito/view/:id',
    component: ViewCarritoComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'carrito/edit/:id',
    component: EditCarritoComponent,
    resolve: { message: SessionResolver },
  },
  {
    path: 'carrito/remove/:id',
    component: RemoveCarritoComponent,
    resolve: { message: SessionResolver },
  },
];
