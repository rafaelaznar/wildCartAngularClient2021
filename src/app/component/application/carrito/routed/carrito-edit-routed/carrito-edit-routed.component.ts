...
@Component({
  selector: 'app-carrito-edit-routed',
  templateUrl: './carrito-edit-routed.component.html',
  styleUrls: ['./carrito-edit-routed.component.css'],
})
export class CarritoEditRoutedComponent implements OnInit {
