...
@Component({
  selector: 'app-carrito-plist-routed.',
  templateUrl: './carrito-plist-routed.component.html',
  styleUrls: ['./carrito-plist-routed.component.css'],
})

export class CarritoPlistRoutedComponent implements OnInit {
