...
@Component({
  selector: 'app-carrito-cplist-unrouted',
  templateUrl: './carrito-cplist-unrouted.component.html',
  styleUrls: ['./carrito-cplist-unrouted.component.css'],
})
export class CarritoCPlistUnroutedComponent implements OnInit {
