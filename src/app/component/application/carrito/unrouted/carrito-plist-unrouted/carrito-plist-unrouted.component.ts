...
@Component({
  selector: 'app-carrito-plist-unrouted',
  templateUrl: './carrito-plist-unrouted.component.html',
  styleUrls: ['./carrito-plist-unrouted.component.css'],
})
export class CarritoPlistUnroutedComponent implements OnInit {
