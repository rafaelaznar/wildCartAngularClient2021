...
@Component({
  selector: 'app-carrito-plist-AU',
  templateUrl: './carrito-plist-AU.component.html',
  styleUrls: ['./carrito-plist-AU.component.css'],
})
export class CarritoPlistAUComponent implements OnInit {
