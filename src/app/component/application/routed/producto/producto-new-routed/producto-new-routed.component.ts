...
@Component({
  selector: 'app-producto-new-routed',
  templateUrl: './producto-new-routed.component.html',
  styleUrls: ['./producto-new-routed.component.css']
})

export class ProductoNewRoutedComponent implements OnInit {
