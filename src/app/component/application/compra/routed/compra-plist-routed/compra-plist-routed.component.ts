...
@Component({
  selector: 'app-compra-plist-routed.',
  templateUrl: './compra-plist-routed.component.html',
  styleUrls: ['./compra-plist-routed.component.css'],
})

export class CompraPlistRoutedComponent implements OnInit {
