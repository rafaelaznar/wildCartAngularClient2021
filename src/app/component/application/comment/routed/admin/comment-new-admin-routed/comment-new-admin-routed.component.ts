...
@Component({
  selector: 'app-comment-new-admin-routed',
  templateUrl: './comment-new-admin-routed.component.html',
  styleUrls: ['./comment-new-admin-routed.component.css']
})

export class CommentNewAdminRoutedComponent extends CheckSession implements OnInit {
