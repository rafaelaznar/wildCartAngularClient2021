...
export class UsuarioSelectionAdminUnroutedComponent implements OnInit {
  ...
  getPage = () => {
    this.oUsuarioService.getPage(this.oPage.number, this.oPage.size, this.oPage.strSortField, this.oPage.strSortDirection, this.oPage.strFilter, this.id_tipousuario).subscribe((oPage: IUsuarioPage) => {
      this.oPage = oPage;
